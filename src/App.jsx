  ...
  return (
    <div className="flex flex-col items-center p-4 mt-10">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl overflow-hidden p-8 text-center">
        ...
        <p className="text-gray-500 text-sm mb-6">請輸入密碼以查看報修案件<br/>(預設測試密碼為: 8888)</p>
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden">
        <div className="bg-gradient-to-r from-blue-700 to-blue-900 px-6 py-8 text-white relative">
          <div className="relative z-10">
            ...
            {source && (
              <div className="mt-3 inline-block bg-white text-blue-800 text-xs font-bold px-3 py-1 rounded-full shadow-sm">
                目前分店：{source}
              </div>
            )}
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-bold transition-all ${
              reports.length === 0 ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700 text-white shadow-sm'
            }`}
          >
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex flex-col items-end gap-1 shrink-0">
                      ...
                      {report.source && report.source !== '一般網頁' && (
                        <div className="text-xs font-bold px-2 py-1 rounded-md bg-purple-100 text-purple-700">
                          來源：{report.source}
                        </div>
                      )}
      ...
      {downloadModal && (
        <div className="fixed inset-0 z-[110] bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full text-center relative">
            <button onClick={() => setDownloadModal(null)} className="absolute top-4 right-4 text-gray-400 hover:text-gray-600">
              <X className="w-6 h-6" />
            </button>
            ...
            <a 
              ...
              onClick={() => setTimeout(() => setDownloadModal(null), 1000)}
